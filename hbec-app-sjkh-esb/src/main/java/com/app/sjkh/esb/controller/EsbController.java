package com.app.sjkh.esb.controller;

import com.apex.fix.JFixComm;
import com.app.sjkh.esb.pojo.Constants;
import com.app.sjkh.esb.pojo.EsbServiceEnum;
import com.app.sjkh.esb.pojo.ResultCode;
import com.app.sjkh.esb.pojo.ResultResponse;
import com.app.sjkh.esb.service.ApiService;
import com.app.sjkh.esb.utils.JacksonUtil;
import com.app.sjkh.esb.utils.PropertiesUtils;
...
public class EsbController {
    ...
    private static final Log logger = LogFactory.getLog(EsbController.class);
    ...
    private String esbBusinessService(String serviceId, Map<String, String> map) throws IOException {
        String result;
    ...
    private String esbBusinessUploadFile(String fileName, String filePath, Map<String, String> map) throws IOException {
        String result;
    ...
    private String esbBusinessUploadFile(String fileName, byte[] bytes, Map<String, String> map) throws IOException {
        String result;
    ...
    private void esbBusinessDownloadFile(Map<String, String> map) throws IOException, URISyntaxException, KeyStoreException {
     ...
     * @return
     */
    private String getEsbUrl(String business) {
     ...
     * @return
     */
    private Map<String, String> initPublicParam() {
        Map<String, String> map = new HashMap<String, String>();
     ...
     * @return
     */
    private Boolean resultTimeOut(String result, Boolean timeout) {
     ...
     */
    @RequestMapping(value = "queryBankInfoByDingDian", method = RequestMethod.POST)
    @ResponseBody
    public ResultResponse queryBankInfoByDingDian(HttpServletRequest request) {
     ...
     */
    @RequestMapping(value = "queryCustomerInfoByDingDian", method = RequestMethod.POST)
    @ResponseBody
    public ResultResponse queryCustomerInfoByDingDian(HttpServletRequest request) {
        String bslx = request.getParameter("bslx");
        String srbs = request.getParameter("srbs");
        if (StringUtils.isBlank(bslx) || StringUtils.isBlank(srbs)){
            return ResultResponse.build(ResultCode.HBEC_001004.getCode(),ResultCode.HBEC_001004.getMemo());
        }
        try {
            Map<String, String> params = new HashMap<String, String>();
     ...
     * 交易密码校验
     *
     * @param request (customerId,password,ip)
     * @return 001027, 验证通过
     * 001028,验证失败
     * 客户交易密码验证{"clzt":0,"code":1,"count":0,"duration":"84.529ms","note":"密码效验通过"}
     * 接口[esb.ygt.khgl.khjymmyz][客户资金密码验证]调用失败:资金密码有误
     */
    @RequestMapping(value = "vaildataTradePwd", method = RequestMethod.POST)
    @ResponseBody
    public ResultResponse vaildataTradePwd(HttpServletRequest request) {
        String customerId = request.getParameter("customerId");
     ...
     * 001003,系统异常
     */
    @RequestMapping(value = "queryAgentRecommendInfo", method = RequestMethod.POST)
    @ResponseBody
    public ResultResponse queryAgentRecommendInfo(HttpServletRequest request) {

        String jjrId = request.getParameter("jjrId");
        if (StringUtils.isBlank(jjrId)){
            return ResultResponse.build(ResultCode.HBEC_001004.getCode(),ResultCode.HBEC_001004.getMemo());
        }
     ...
     * 001003,系统异常
     */
    @RequestMapping(value = "queryQuickBankCard", method = RequestMethod.POST)
    @ResponseBody
    public ResultResponse queryQuickBankCard (HttpServletRequest request){
