 ...
 * @hSea v1.1.5
 * @author liaohl
 * @datetime 2014-08-01 01:24:33 PM
 * @Copyright thinkive
 */
!function(a, b) {
    function c(a) {
    ...
    function e(a, b) {
        ...
        A.test(a))
            ...
            for (c = (b ? b.match(v)[0] : k.cwd) + a,
            c = c.replace(w, "/"); c.match(x); )
                c = c.replace(x, "/");
        else
            c = "/" === c ? (c = k.cwd.match(B)) ? c[0] + a.substring(1) : a : k.base + a;
        return c
    }
    function f(a, b) {
        if (!a)
            return "";
        var c, d = a, f = k.alias, d = a = f && m(f[d]) ? f[d] : d, f = k.paths;
        ...
        var d = k.map
          , h = c;
        if (d)
            for (var f = 0, i = d.length; i > f && (h = d[f],
            h = o(h) ? h(c) || c : c.replace(h[0], h[1]),
            !(h !== c)); f++)
                ;
        return h
    }
    ...
    if (!a.seajs) {
        ...
        i.prototype.resolve = function() {
            for (var a = this.dependencies, b = [], c = 0, d = a.length; d > c; c++)
                b[c] = i.resolve(a[c], this.uri);
            return b
        }
        ,
        i.prototype.load = function() {
            if (!(this.status >= R.LOADING)) {
                ...
                var a = this.resolve();
                u("load", a);
                for (var b, c = this._remain = a.length, d = 0; c > d; d++)
                    b = i.get(a[d]),
                    b.status < R.LOADED ? b._waitings[this.uri] = (b._waitings[this.uri] || 0) + 1 : this._remain--;
                if (0 === this._remain)
                    this.onload();
                else {
                    for (var e = {}, d = 0; c > d; d++)
                        b = N[a[d]],
                        b.status < R.FETCHING ? b.fetch(e) : b.status === R.SAVED && b.load();
                    for (var f in e)
        ...
        i.prototype.onload = function() {
            this.status = R.LOADED,
            this.callback && this.callback();
            var a, b, c = this._waitings;
            for (a in c)
                c.hasOwnProperty(a) && (b = N[a],
                b._remain -= c[a],
                0 === b._remain) && b.onload();
        ...
        i.prototype.fetch = function(a) {
            function b() {
                ...
                !d || !K && "onload"in h ? h.onload = h.onerror = h.onreadystatechange = function() {
                    J.test(h.readyState) && (h.onload = h.onerror = h.onreadystatechange = null ,
                    !d && !k.debug && G.removeChild(h),
                    h = null ,
                    b())
                }
                : setTimeout(function() {
            ...
            !f || P[f] ? this.load() : O[f] ? Q[f].push(this) : (O[f] = !0,
            Q[f] = [this],
            u("request", e = {
                uri: d,
                requestUri: f,
        ...
        i.prototype.exec = function() {
            ...
            a.async = function(b, d) {
                return i.use(b, d, c + "_async_" + p++),
                a
            }
            ;
            var d = this.factory
              , d = o(d) ? d(a, this.exports = {}, this) : d;
            return d === b && (d = this.exports),
            null === d && !I.test(c) && u("error", this),
            delete this.factory,
            this.exports = d,
            this.status = R.EXECUTED,
            u("exec", this),
            d
        }
        ,
        ...
        k.cid = d,
        j.resolve = f,
        j.require = function(a) {
            return (N[i.resolve(a)] || {}).exports
        }
        ,
        k.base = (F.match(/^(.+?\/)(\?\?)?(seajs\/)+/) || ["", F])[1],
        k.dir = F,
        k.cwd = E,
        k.charset = "utf-8";
        var E = k
        ...
        j.config = function(a) {
            for (var b in a) {
                ...
                if (d && l(d))
                    ...
                    n(d) ? c = d.concat(c) : "base" === b && ("/" === c.slice(-1) || (c += "/"),
                    c = e(c)),
                    k[b] = c
            }
            return u("config", a),
...
seajs.use("./configuration.js?v=" + seajs._sysVersion, function(a) {
    seajs.config({
        _preDo: function(a) {
            ...
            console.printStackTrace = function(a) {
                var b = a.message
                  , c = a.stack;
                b && console.log("错误说明：" + b),
                c && console.log("错误堆栈：" + c)
            }
            ,
            ""
        }(window),
        vars: function() {
            ...
            case "1":
                ...
                break;
            case "2":
                var d = a.seaBaseUrl || "/m/"
                  , e = "file://" + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") - d.length + 1);
                b = e = a.global.h5Path;
                break;
            case "3":
                b = "appfile:";
            ...
            return seajs._platRoot = b,
            {
                platRoot: seajs._platRoot,
                pluginBaseUrl: seajs._platRoot + (a.seaBaseUrl || "/m/")
            }
        }(),
        base: seajs._platRoot + (a.seaBaseUrl ? a.seaBaseUrl : "/m/"),
        alias: function() {
            var b = {
            ...
            for (var d in c)
                b[d] = c[d];
            return "1" == a.platform || "2" == a.platform || "4" == a.platform || "5" == a.platform ? ("1" == a.platform || "4" == a.platform ? b.cordova = "plugins/phonegap/scripts/cordova_android" : ("2" == a.platform || "5" == a.platform) && (b.cordova = "plugins/phonegap/scripts/cordova_ios"),
            b.shellPlugin = "plugins/phonegap/scripts/pgPlugin") : "3" == a.platform ? b.shellPlugin = "plugins/phonegap/scripts/airPlugin" : "0" == a.platform && (b.shellPlugin = "plugins/phonegap/scripts/pgPlugin"),
            b
        }(window),
    ...
    setTimeout(function() {
        seajs.use(["/m/base/main", "/m/base/jquery/jquery"], function(a, b) {
...
define("/m/base/jquery/jquery", [], function(a, b, c) {
    !function(a, b) {
        function c(a) {
            var b = ob[a] = {};
        ...
        function n(a, b) {
            ...
            $.support.html5Clone && a.innerHTML && !$.trim(b.innerHTML) && (b.innerHTML = a.innerHTML)) : "input" === c && Xb.test(a.type) ? (b.defaultChecked = b.checked = a.checked,
        ...
        function s(a, b) {
            for (var c, d, e = [], f = 0, g = a.length; g > f; f++)
                ...
                "" === c.style.display && r(c) && (e[f] = $._data(c, "olddisplay", w(c.nodeName)))) : (d = cc(c, "display"),
        ...
        function u(a, b, c, d) {
            for (var e = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0, f = 0; 4 > e; e += 2)
                "margin" === c && (f += $.css(a, c + qc[e], !0)),
                d ? ("content" === c && (f -= parseFloat(cc(a, "padding" + qc[e])) || 0),
                "margin" !== c && (f -= parseFloat(cc(a, "border" + qc[e] + "Width")) || 0)) : (f += parseFloat(cc(a, "padding" + qc[e])) || 0,
                "padding" !== c && (f += parseFloat(cc(a, "border" + qc[e] + "Width")) || 0));
            return f
        }
        function v(a, b, c) {
        ...
        function w(a) {
            ...
            ec && dc.createElement || (ec = (dc.contentWindow || dc.contentDocument).document,
            ec.write("<!doctype html><html><body>"),
            ec.close()),
            b = ec.body.appendChild(ec.createElement(a)),
            c = cc(b, "display"),
            P.body.removeChild(dc)),
            nc[a] = c,
            c
        }
        function x(a, b, c, d) {
        ...
        function z(a, c, d, e, f, g) {
            ...
            g = g || {},
            g[f] = !0;
            for (var h, i = a[f], j = 0, k = i ? i.length : 0, l = a === Kc; k > j && (l || !h); j++)
                h = i[j](c, d, e),
        ...
        function H(a, b, c) {
            var d, e = 0, f = $c.length, g = $.Deferred().always(function() {
                ...
                for (var b = Vc || F(), c = Math.max(0, i.startTime + i.duration - b), d = 1 - (c / i.duration || 0), e = 0, f = i.tweens.length; f > e; e++)
                    i.tweens[e].run(d);
                return g.notifyWith(a, [i, d, c]),
                1 > d && f ? c : (g.resolveWith(a, [i]),
                !1)
            }
            , i = g.promise({
                elem: a,
        ...
        , mb = function() {
            P.addEventListener ? (P.removeEventListener("DOMContentLoaded", mb, !1),
            $.ready()) : "complete" === P.readyState && (P.detachEvent("onreadystatechange", mb),
            $.ready())
        }
        , nb = {};
        $.fn = $.prototype = {
            ...
            init: function(a, c, d) {
                ...
                if (a.nodeType)
                    ...
                    this;
                if ("string" == typeof a) {
                    if (e = "<" === a.charAt(0) && ">" === a.charAt(a.length - 1) && a.length >= 3 ? [null , a, null ] : db.exec(a),
                    e && (e[1] || !c)) {
                        if (e[1])
        ...
        $.extend({
            ...
            parseHTML: function(a, b, c) {
                ...
                b = 0),
                b = b || P,
                (d = eb.exec(a)) ? [b.createElement(d[1])] : (d = $.buildFragment([a], b, c ? null : []),
                $.merge([], (d.cacheable ? $.clone(d.fragment) : d.fragment).childNodes))) : null
            },
            parseJSON: function(b) {
                return b && "string" == typeof b ? (b = $.trim(b),
                a.JSON && a.JSON.parse ? a.JSON.parse(b) : fb.test(b.replace(hb, "@").replace(ib, "]").replace(gb, "")) ? new Function("return " + b)() : ($.error("Invalid JSON: " + b),
                void 0)) : null
            },
            parseXML: function(c) {
                var d, e;
        ...
        $.ready.promise = function(b) {
            if (!O)
                ...
                "complete" === P.readyState)
                    ...
                    P.addEventListener("DOMContentLoaded", mb, !1),
            ...
            val: function(a) {
                var c, d, e, f = this[0];
                {
                    ...
                    if (f)
                        ...
                        "string" == typeof d ? d.replace(vb, "") : null == d ? "" : d)
                }
            }
        }),
        $.extend({
            ...
            attr: function(a, c, d, e) {
                ...
                if (a && 3 !== i && 8 !== i && 2 !== i)
                    ...
                    h && (c = c.toLowerCase(),
                    g = $.attrHooks[c] || (zb.test(c) ? sb : rb)),
                    d !== b ? null === d ? ($.removeAttr(a, c),
            ...
            attrHooks: {
                ...
                value: {
                    ...
                    set: function(a, b, c) {
                        return rb && $.nodeName(a, "button") ? rb.set(a, b, c) : (a.value = b,
                        void 0)
                    }
                }
            },
        ...
        $.support.submitBubbles || ($.event.special.submit = {
            ...
            teardown: function() {
                return $.nodeName(this, "form") ? !1 : ($.event.remove(this, "._submit"),
                void 0)
            }
        }),
        ...
        function(a, b) {
            ...
            function h(a, b) {
                ...
                i = [],
                j = t.preFilter; h; ) {
                    (!d || (e = _.exec(h))) && (e && (h = h.slice(e[0].length)),
                    i.push(f = [])),
                    d = !1,
                    (e = ab.exec(h)) && (f.push(d = new E(e.shift())),
                    h = h.slice(d.length),
                    d.type = e[0].replace(Z, " "));
                    for (g in t.filter)
                        (e = hb[g].exec(h)) && (!j[g] || (e = j[g](e, F, !0))) && (f.push(d = new E(e.shift())),
                        h = h.slice(d.length),
                        d.type = g,
                        d.matches = e);
                    if (!d)
            ...
            function l(a, b, c, d, e, f) {
                ...
                N(function(f, g, h, i) {
                    if (!f || !e) {
                        var j, l, m, n = [], p = [], q = g.length, r = f || o(b || "*", h.nodeType ? [h] : h, [], f), s = !a || !f && b ? r : k(r, n, a, h, i), t = c ? e || (f ? a : q || d) ? [] : g : s;
                        if (c && c(s, t, h, i),
                        d)
                            for (m = k(t, p),
                            d(m, [], h, i),
            ...
            function p(a, b, c, d, e) {
                ...
                if (!d && 1 === l.length) {
                    ...
                    g.length > 2 && "ID" === (i = g[0]).type && 9 === b.nodeType && !e && t.relative[g[1].type]) {
                        if (b = t.find.ID(i.matches[0].replace(gb, ""), b, e)[0],
                        !b)
                            return c;
                        a = a.slice(g.shift().length)
                    }
                    for (f = hb.POS.test(a) ? -1 : g.length - 1; f >= 0 && (i = g[f],
            ...
            c.attr = function(a, b) {
                ...
                (c = t.attrHandle[b]) ? c(a) : d || lb ? a.getAttribute(b) : (c = a.getAttributeNode(b),
            ...
            t = c.selectors = {
                ...
                preFilter: {
                    ...
                    PSEUDO: function(a) {
                        var b, c;
                        return hb.CHILD.test(a[0]) ? null : (a[3] ? a[2] = a[3] : (b = a[4]) && (bb.test(b) && (c = h(b, !0)) && (c = b.indexOf(")", b.length - c) - b.length) && (b = b.slice(0, c),
                        a[0] = a[0].slice(0, c)),
                        a[2] = b),
                        a.slice(0, 3))
                    }
                ...
                filter: {
                    ...
                    ATTR: function(a, b, d) {
                        return function(e) {
                            var f = c.attr(e, a);
                            return null == f ? "!=" === b : b ? (f += "",
                            "=" === b ? f === d : "!=" === b ? f !== d : "^=" === b ? d && 0 === f.indexOf(d) : "*=" === b ? d && f.indexOf(d) > -1 : "$=" === b ? d && f.substr(f.length - d.length) === d : "~=" === b ? (" " + f + " ").indexOf(d) > -1 : "|=" === b ? f === d || f.substr(0, d.length + 1) === d + "-" : !1) : !0
                        }
                    },
            ...
            F.querySelectorAll && function() {
                var a, b = p, d = /'|\\/g, e = /\=[\x20\t\r\n\f]*([^'"\]]*)[\x20\t\r\n\f]*\]/g, f = [":focus"], g = [":active", ":focus"], i = G.matchesSelector || G.mozMatchesSelector || G.webkitMatchesSelector || G.oMatchesSelector || G.msMatchesSelector;
                ib(function(a) {
        ...
        $.buildFragment = function(a, c, d) {
            ...
            c = !c.nodeType && c[0] || c,
            c = c.ownerDocument || c,
            1 === a.length && "string" == typeof h && h.length < 512 && c === P && "<" === h.charAt(0) && !Vb.test(h) && ($.support.checkClone || !Yb.test(h)) && ($.support.html5Clone || !Wb.test(h)) && (f = !0,
            e = $.fragments[h],
            g = e !== b),
        ...
        $.extend({
            clone: function(a, b, c) {
                var d, e, f, g;
                if ($.support.html5Clone || $.isXMLDoc(a) || !Wb.test("<" + a.nodeName + ">") ? g = a.cloneNode(!0) : (bc.innerHTML = a.outerHTML,
                bc.removeChild(g = bc.firstChild)),
                    ...
                    g) {
                        if ("string" == typeof g)
                            if (Tb.test(g)) {
                                ...
                                !$.support.leadingWhitespace && Pb.test(g) && l.insertBefore(b.createTextNode(Pb.exec(g)[0]), l.firstChild),
                                g = l.childNodes,
        ...
        var cc, dc, ec, fc = /alpha\([^)]*\)/i, gc = /opacity=([^)]*)/, hc = /^(top|right|bottom|left)$/, ic = /^(none|table(?!-c[ea]).+)/, jc = /^margin/, kc = new RegExp("^(" + _ + ")(.*)$","i"), lc = new RegExp("^(" + _ + ")(?!px)[a-z%]+$","i"), mc = new RegExp("^([-+])=(" + _ + ")","i"), nc = {}, oc = {
            position: "absolute",
            visibility: "hidden",
            display: "block"
        }, pc = {
        ...
        $.extend({
            ...
            style: function(a, c, d, e) {
                if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                    ...
                    if (g = typeof d,
                    "string" === g && (f = mc.exec(d)) && (d = (f[1] + 1) * f[2] + parseFloat($.css(a, c)),
                    g = "number"),
        ...
        $.support.opacity || ($.cssHooks.opacity = {
            ...
            set: function(a, b) {
                ...
                c.zoom = 1,
                b >= 1 && "" === $.trim(f.replace(fc, "")) && c.removeAttribute && (c.removeAttribute("filter"),
                d && !d.filter) || (c.filter = fc.test(f) ? f.replace(fc, e) : f + " " + e)
            }
        }),
        $(function() {
        ...
        $.extend({
            ...
            ajax: function(a, c) {
                ...
                ,
                m.url = ((a || m.url) + "").replace(Ac, "").replace(Ec, yc[1] + "//"),
                m.dataTypes = $.trim(m.dataType || "*").toLowerCase().split(bb),
                null == m.crossDomain && (j = Ic.exec(m.url.toLowerCase()) || !1,
                m.crossDomain = j && j.join(":") + (j[3] ? "" : "http:" === j[1] ? 80 : 443) !== yc.join(":") + (yc[3] ? "" : "http:" === yc[1] ? 80 : 443)),
                ...
                m.hasContent = !Dc.test(m.type),
                k && 0 === $.active++ && $.event.trigger("ajaxStart"),
                !m.hasContent && (m.data && (m.url += (Fc.test(m.url) ? "&" : "?") + m.data,
                delete m.data),
                e = m.url,
                m.cache === !1)) {
                    var x = $.now()
        ...
        $.ajaxPrefilter("json jsonp", function(c, d, e) {
            ...
            g = a[f],
            l ? c.url = j.replace(Qc, "$1" + f) : m ? c.data = i.replace(Qc, "$1" + f) : k && (c.url += (Pc.test(j) ? "&" : "?") + c.jsonp + "=" + f),
            ...
            if (!c.crossDomain || $.support.cors) {
                ...
                return {
                    send: function(e, f) {
                        ...
                        ,
                        c.async ? 4 === i.readyState ? setTimeout(d, 0) : (g = ++Uc,
                        Tc && (Sc || (Sc = {},
                        $(a).unload(Tc)),
                        Sc[g] = d),
        ...
        $.each({
            ...
            $.fn[a] = function(e) {
                return $.access(this, function(a, e, f) {
                    var g = M(a);
                    return f === b ? g ? c in g ? g[c] : g.document.documentElement[e] : a[e] : (g ? g.scrollTo(d ? $(g).scrollLeft() : f, d ? f : $(g).scrollTop()) : a[e] = f,
                    void 0)
    ...
    c.exports = $ = jQuery = window.jQuery = window.$
}),
define("/m/base/jquery/jquery.scrollto", ["/m/base/jquery/jquery"], function(a) {
    jQuery = a("/m/base/jquery/jquery");
    ...
    jQuery.fx.ScrollTo = function(a, b, c, d) {
        ...
        e.step = function() {
            ...
            a >= e.o.duration + e.t ? (e.clear(),
            setTimeout(function() {
                e.scroll(e.p.y, e.p.x)
            }, 13)) : (st = (-Math.cos(b * Math.PI) / 2 + .5) * (e.p.y - e.s.t) + e.s.t,
            sl = (-Math.cos(b * Math.PI) / 2 + .5) * (e.p.x - e.s.l) + e.s.l,
            e.scroll(st, sl))
        }
        ,
...
define("/m/base/main", ["/m/base/util/nativeJsExt", "/m/base/jquery/jquery.scrollto", "/m/base/util/appUtils", "jquery", "gconfig", "layerUtils", "{pluginBaseUrl}plugins/endecrypt/scripts/aes", "websocket", "ajax", "/m/base/util/gconfig", "{pluginBaseUrl}plugins/layer/scripts/layerUtils", "layer"], function(a, b, c) {
    function d() {
        function b() {
            var a = encodeURIComponent(window.location.href)
              , b = a.indexOf("?") > -1 ? a.substring(a.indexOf("?") + 1).split("&") : []
              , c = {};
            return b.forEach(function(a) {
                if (a = a.split("="),
                a.length > 1) {
                    for (var b = [], d = 1, e = a.length; e > d; d++)
                        b[d - 1] = a[d];
                    a[1] = b.join("=")
                }
        ...
        function c() {
            ...
            if (-1 == a.indexOf("#!/"))
                return "";
            var b = a.indexOf("#!/") + 3
              , c = -1 == a.lastIndexOf(".html") ? a.length : a.lastIndexOf(".html");
            return a.substring(b, c)
        }
        function d() {
            var d = c()
              , e = b();
            j.global.isMultiple && (d = e.pageCode,
            d && d.indexOf("_") > -1 && (d = d.replaceAll("_", "/"))),
            a.async(j.scriptsPath + d, function(a) {
                if (a)
                    i.pageInit(i.getSStorageInfo("_prePageCode"), d, e);
                else {
                    var b = i.getLStorageInfo("isGuided");
                    if ("true" == b) {
                        var c = j.defaultPage;
                        i.pageInit(i.getSStorageInfo("_prePageCode"), c.pageCode, c.jsonParam),
                        console.log("进入默认页面~~")
                    } else {
                        var f = j.guidePage;
                        if (f)
                            i.pageInit(i.getSStorageInfo("_prePageCode"), f.pageCode, f.jsonParam);
                        else {
                            var c = j.defaultPage;
                            i.pageInit(i.getSStorageInfo("_prePageCode"), c.pageCode, c.jsonParam),
                            console.log("进入默认页面~~")
            ...
            window.onpopstate = function(b) {
                ...
                if (b && b.state) {
                    ...
                    c.pageCode)
                      ...
                      , h = c.isShowWait
                      , k = c.isShowOverLay
                      , l = i.getSStorageInfo("_curPageCode")
                      , m = e.replaceAll("/", "_");
                    if (i.setSStorageInfo("_curPage", JSON.stringify(c)),
                    $("#" + m).length < 1 || "yes" == $("#" + m).attr("data-refresh") || "true" == $("#" + m).attr("data-refresh"))
                        i.pageInit(l, e, f, g, h, k),
                        i.setSStorageInfo("_prePageCode", l),
                        i.setSStorageInfo("_curPageCode", e);
                    else {
                        var n = $("#" + m).attr("data-pageTitle");
                        n = n ? n : "3GWeb",
                        document.title = n,
                        l = l && "null" != l ? l : "",
                        i.clearRequest(),
                        a.async(j.scriptsPath + l, function(a) {
                            a.destroy ? a.destroy() : i.pageResetValue(l.replaceAll("/", "_")),
                            i.switchPage(m),
                            i.setSStorageInfo("_curPageCode", e),
                            i.setSStorageInfo("_prePageCode", l)
                        })
                    ...
                    location.href.indexOf(i.preHashUrl) < 0 && -1 != location.href.indexOf("#!") ? i.startInitFlag && d() : (history.go(-1),
                    iBrowser.weixin && WeixinJSBridge.call("closeWindow"))
            }
        }
        function f() {
            "0" != j.platform && "3" != j.platform && a.async("cordova", function() {
                a.async("shellPlugin", function(a) {
        ...
        function g() {
            if (j.isControlProcess) {
                var a = i.getLStorageInfo("_freeTime");
                a && a != j.freeTime ? j.freeTime = a : i.setLStorageInfo("_freeTime", j.freeTime),
                i.bindEvent($(document), function() {
                    j.isControlProcess && (l = (new Date).getTime())
                }),
                setInterval(function() {
                    (new Date).getTime() - l > 60 * j.freeTime * 1e3 && (l = (new Date).getTime(),
                    h())
                }, 6e4)
            }
        }
        function h() {
            var a = i.getSStorageInfo("_curPage")
              , b = JSON.parse(a)
              , c = j.loginPage;
            b && b.pageCode != c.pageCode && "true" == i.getSStorageInfo("_isLoginIn") && (i.pageInit(i.getSStorageInfo("_prePageCode"), c.pageCode, c.jsonParam),
            setTimeout(function() {
                k.iAlert("您长时间不操作，系统已自动退出！")
            }, 400))
        }
        a("/m/base/util/nativeJsExt"),
        a("/m/base/jquery/jquery.scrollto");
        var i = a("/m/base/util/appUtils")
          , j = a("/m/base/util/gconfig")
          , k = a("{pluginBaseUrl}plugins/layer/scripts/layerUtils")
          , l = (new Date).getTime();
        a.async(j.firstLoadCss, function() {
            {
                var a = i.getSStorageInfo("_curPage")
                  , h = a ? JSON.parse(a) : null ;
                window.location.href
            }
            if (h && c() == h.pageCode) {
                var k = h.pageCode
                  , l = "{}" != JSON.stringify(b()) && b() != h.param ? b() : h.param
                  , m = h.isLastReq
                  , n = h.isShowWait
                  , o = h.isShowOverLay;
                i.pageInit("", k, l, m, n, o),
                i.startInitFlag = !1,
                j.global.isMultiple || setTimeout(function() {
                    e()
                }, 200),
                f(),
                g()
                ...
                f(),
                g();
            "0" != j.platform && setInterval(function() {}, 5e3),
...
define("/m/base/util/ajax", ["/m/base/jquery/jquery", "{pluginBaseUrl}plugins/layer/scripts/layerUtils", "jquery", "layer", "gconfig", "/m/base/util/gconfig"], function(a, b, c) {
    function d() {
    ...
    function e(b, c, d, e, f, j, k, l, m, n) {
        e = "undefined" == typeof e || "" === e ? !0 : e,
        f = "undefined" == typeof f || "" === f ? !0 : f,
        j = "undefined" == typeof j || "" === j ? !0 : j,
        k = "undefined" == typeof k || "" === k ? !0 : k,
        l = l || "请等待...",
        n = n || "json",
        sessionStorage.jsessionid && b.indexOf(";jsessionid=") < 0 && (b = b + ";jsessionid=" + sessionStorage.jsessionid);
        for (var o in c) {
            var p = c[o] + "";
            null === p || void 0 === p || "" === p || "null" === p.trim().toLowerCase() || "undefined" === p.trim().toLowerCase() ? c[o] = "" : (p = encodeURIComponent(p),
            c[o] = p)
        }
        var q = {
            withCredentials: !0
        ...
        var r = g.ajax({
            ...
            success: function(a) {
                a ? d && d(a) : h.iMsg(-1, "后台返回数据格式不正确，请联系管理员！")
            },
            complete: function() {
                j && e && h.iLoading(!1)
            },
            error: function() {
                h.iLoading(!1),
                a("/m/base/util/gconfig").global.isOnline === !1 && a.async("shellPlugin", function(a) {
                    a.callShellMethod("toastPlugin", null , function() {
                        h.iMsg(-1, "网络不可用，请检查您的网络设置!")
                    }, {
        ...
        i.push(r);
        var s = a("/m/base/util/gconfig").ajaxTimeout;
        setTimeout(function() {
            r && r.readyState && 4 != r.readyState && (r.abort(),
            m ? m() : h.iMsg(-1, "请求超时，请检查接口是否异常或者网络不通！"))
        }, 1e3 * parseInt(s))
    }
    function f(a, b, c, d, e, f) {
        c = "undefined" == typeof c || "" === c ? !0 : c,
        d = "undefined" == typeof d || "" == d ? !0 : d,
        e = "undefined" == typeof e || "" === e ? !0 : e,
        f = "undefined" == typeof f || "" === f ? !0 : f,
        g.ajax({
            ...
            beforeSend: function() {
                e && h.iLoading(!0, "请等待...", f)
            },
            success: function(c) {
                c ? b && b(c) : console.log("请求html页面异常或者页面不存在！>>" + a)
            },
            complete: function() {
                c && h.iLoading(!1)
            },
            error: function() {
                h.iLoading(!1),
                console.log("请求html页面异常！>>" + a)
            }
        })
    }
    var g = jQuery = a("/m/base/jquery/jquery")
      , h = a("{pluginBaseUrl}plugins/layer/scripts/layerUtils")
      , i = []
      , j = {
        clearAjaxReq: d,
        reqByAjax: e,
...
define("/m/base/util/appUtils", ["/m/base/jquery/jquery", "/m/base/util/gconfig", "{pluginBaseUrl}plugins/layer/scripts/layerUtils", "jquery", "layer", "gconfig", "{pluginBaseUrl}plugins/endecrypt/scripts/aes", "/m/base/util/websocket", "layerUtils", "/m/base/util/ajax"], function(a, b, c) {
    function d(a, b) {
    ...
    function e(a, b) {
        E(document.body).ScrollTo(0),
        E("#" + a).siblings(".page").attr("data-display", "none"),
        E("#" + a).attr("data-display", "block"),
        G.iLayerClose(),
        F.isSmoothTran ? 1 == b ? E("#" + a).siblings(".page").animate({
            width: "hide",
            marginLeft: "hide",
            paddingLeft: "hide"
        }, 0, "swing", function() {
        ...
        }) : (E("#" + a).siblings(".page").hide(),
        E("#" + a).show()),
        I.preHashUrl = location.href
    }
    function f(a) {
        E("#" + a + " input").each(function() {
            var a = E(this).attr("type")
              , b = E(this).attr("disabled");
            if (("text" == a || "password" == a || "number" == a) && !b) {
                var c = E(this).attr("data-origin");
                c ? E(this).val(c) : E(this).val("")
            }
        }),
        E("#" + a + " select").each(function() {
            var a = E(this).attr("data-origin") ? E(this).attr("data-origin") : 0;
            E(this).children("option").eq(a).attr("selected", "true")
        })
    }
    function g() {
        var a = (new Date).format("HHmmss")
          , b = parseFloat(a);
        return b >= 93e3 && 113e3 >= b || b >= 13e4 && 15e4 >= b ? !0 : !1
    }
    function h(a, b, c) {
        c = c ? c : F.triggerEventName,
        E(a).off(c),
        E(a).on(c, b)
    }
    function i(a, b, c, d) {
        d = d ? d : F.triggerEventName,
        E(a).off(d, b),
        E(a).on(d, b, c)
    }
    function j(b, c, d) {
        try {
            var e = F.global.aesKey;
            if (c = null != c ? c : "",
            d && e) {
                var f = a("{pluginBaseUrl}plugins/endecrypt/scripts/aes")
                  , g = f.enc.Utf8.parse(e)
                  , h = f.enc.Utf8.parse(c)
                  , i = f.enc.Utf8.parse(e)
                  , j = f.AES.encrypt(h, g, {
                    iv: i,
                    mode: f.mode.CBC
                });
            ...
            G.iAlert("您的浏览器版本太低，不支持sessionStorage！")
        }
    }
    function k(b, c) {
        try {
            ...
            if (c && e) {
                ...
                var f = a("{pluginBaseUrl}plugins/endecrypt/scripts/aes")
                  , g = f.enc.Utf8.parse(e)
                  , h = f.enc.Utf8.parse(e)
                  , i = f.enc.Base64.parse(d)
                  , j = f.AES.decrypt({
                    ciphertext: i
                }, g, {
                    iv: h,
                ...
                d = j.toString(f.enc.Utf8)
            }
            return d ? d : null
        } catch (k) {
            return G.iAlert("您的浏览器版本太低，不支持sessionStorage！"),
            null
        }
    }
    function l(b, c, d) {
        try {
            ...
            G.iAlert("您的浏览器版本太低，不支持localStorage！")
        }
    }
    function m(b, c) {
        try {
            ...
            return G.iAlert("您的浏览器版本太低，不支持localStorage！"),
            null
        }
    }
    function n(a) {
    ...
    function o(a) {
        try {
            a ? sessionStorage.removeItem(a) : sessionStorage.clear()
        } catch (b) {
            G.iAlert("您的浏览器版本太低，不支持sessionStorage！")
        }
    }
    ...
    function q() {
        if (F.global.isMultiple)
            ...
            var b = k("_curPage")
              ...
              , h = g.replaceAll("/", "_")
              , i = JSON.parse(k(g));
            if (j("_curPage", JSON.stringify(i)),
            E("#" + h).length < 1 || "yes" == E("#" + h).attr("data-refresh") || "true" == E("#" + h).attr("data-refresh"))
                I.pageInit(d, g, i.param, i.isLastReq, i.isShowWait, i.isShowOverLay);
            else {
                var l = E("#" + h).attr("data-pageTitle");
                l = l ? l : "3GWeb",
                document.title = l;
                var m = k("_curPageCode");
                m = m && "null" != m ? m : "",
                s(),
                a.async(F.scriptsPath + m, function(a) {
                    a.destroy ? a.destroy() : f(g.replaceAll("/", "_")),
                    e(h, 0),
                    j("_curPageCode", d)
                })
            }
    ...
    function r(a, b, c) {
        window.history && window.history.pushState ? F.global.isMultiple || window.history.pushState(a, b, c) : console.log("您的浏览器不支持history.pushState！！")
    }
    function s() {
        a("/m/base/util/ajax").clearAjaxReq()
    }
    function t(a) {
        var b = F.resultsParser
          , c = b.errorNo
          , d = b.errorInfo
          , e = a[c] + ""
          , f = a[d]
        ...
        if (i) {
            G.iLoading(!1);
            I.clearSStorage();//会话超时,清除客户端storage
            var j = i.pageCode;
            j ? (I.pageInit(k("_prePageCode"), j, i.jsonParam),
            setTimeout(function() {
                G.iMsg(-1, f)
            }, 400)) : G.iAlert(f),
            g = !0
    ...
    function u(b, c, d, e, f, g, h, i, j, k) {
        a("/m/base/util/ajax").reqByAjax(b, c, function(a) {
            t(a) || d && d(a)
        }, e, f, g, h, i, j, k)
    }
    function v(b, c, d, e, f, g, h) {
        a("/m/base/util/ajax").ajaxPageDiv(c, function(a) {
            b = b || E("body>#bodyContent"),
            b.html(a),
            d && d()
        }, e, f, g, h)
    }
      ...
      setTimeout(function(){
        ...
        try {
            x({
                ...
                callback: function() {
                    E("#" + i).length < 1 ? a("/m/base/util/ajax").ajaxPageDiv(h, function(a) {
                        E("body>#bodyContent").append(a),
                        E("#" + i + " img").each(function() {
                            var a = E(this).attr("src");
                            a && "true" != E(this).attr("data-serverImg") && E(this).attr("src", F.imagesPath + a.substring(a.indexOf("images") + 7))
                        }),
                        y(b, c, d, !0, f, g) && A(b, c, d, e, f, g)
                    }, e, !1, f, g) : y(b, c, d, !0, f, g) && A(b, c, d, e, f, g)
                }
            })
        } catch (j) {
            console.printStackTrace(j)
        }
      },300);
    }
    function x(b) {
        var c = F.checkPermission;
        if (c && c.moduleCode && c.moduleFuncName) {
            var d = c.moduleCode
              , e = c.moduleFuncName;
            a.async(d, function(a) {
                if (a && a[e]) {
                    var c = a[e](b.checkInParam);
                    c === !0 && b.callback()
                }
            })
        } else
    ...
    function y(a, b, c, d, e, f) {
        var g = b.replaceAll("/", "_")
          , h = E("#" + g).attr("data-ischecklogin");
        if ("true" == h) {
            if ("true" == k("_isLoginIn"))
                return !0;
            var i = F.loginPage;
            return i && i.pageCode ? (j("_loginInPageCode", b),
            j("_loginInPageParam", c ? JSON.stringify(c) : ""),
            w(a, i.pageCode, i.jsonParam, d, e, f),
            setTimeout(function() {
                G.iMsg(-1, "请先登录！")
            }, 400)) : G.iAlert("你未登录，且登录页面配置错误！"),
            !1
        }
        return !0
    }
    function z(b) {
        ...
        if (c.isLoad)
            ...
            var d = c.doFunctionObj
              , e = d.moduleCode
              , f = d.moduleFuncName;
            a.async(e, function(a) {
                a && a[f] && a[f](),
                c.isLoad = !0,
                b()
            })
    ...
    function A(b, c, d, g, h, i) {
        b = b && "null" != b ? b : "";
        var j = c.replaceAll("/", "_")
          , k = b.replaceAll("/", "_");
        e(j, 1),
        s(),
        b ? a.async(F.scriptsPath + b, function(e) {
            e.destroy ? (e.destroy(),
            C()) : f(k),
            a.async(F.scriptsPath + c, function(a) {
                B(b, c, d, g, h, i),
                z(function() {
                    if (a.init(),
                    a.bindPageEvent && "yes" != E("#" + j).attr("data-hasBindEvent") && "true" != E("#" + j).attr("data-hasBindEvent") && (a.bindPageEvent(),
                    E("#" + j).attr("data-hasBindEvent", "true")),
                    E("#" + k).length > 0) {
                        var b = E("#" + k).attr("data-isSaveDom");
                        ("no" == b || "false" == b) && E("#" + k).remove()
                    }
                })
            })
        }) : a.async(F.scriptsPath + c, function(a) {
    ...
    function B(a, b, c, d, e, f) {
        if (F.global.isMultiple)
            return !1;
        var g = "";
        !c || "{}" == JSON.stringify(c) || "yes" != E("#" + b.replaceAll("/", "_")).attr("data-urlParam") && "true" != E("#" + b.replaceAll("/", "_")).attr("data-urlParam") || (g = "?" + E.param(c));
        var h = {
            hash: "#!/" + b + ".html" + g,
            prePageCode: a,
            pageCode: b,
          ...
          , i = E("#" + b.replaceAll("/", "_")).attr("data-pageTitle");
        i = i ? i : "3GWeb",
        document.title = i,
        "undefined" == typeof window.history.state ? (r(h, i, h.hash),
        j("_curPage", JSON.stringify(h)),
        j(b, JSON.stringify(h)),
        j("_prePageCode", a),
        j("_curPageCode", b)) : h != window.history.state && (!window.history.state || window.history.state && window.history.state.hash != h.hash) && (r(h, i, h.hash),
        j("_curPage", JSON.stringify(h)),
        j(b, JSON.stringify(h)),
        j("_prePageCode", a),
        j("_curPageCode", b)),
    ...
    function C() {
        for (var a in seajs.cache)
            a.indexOf("_async_") > -1 && delete seajs.cache[a]
    }
    function D(a, b, c) {
        b ? I.setSStorageInfo("_prePageCode", c ? c : "") : o("_prePageCode"),
        I.preHashUrl = location.href,
        location.href = a
    }
    var E = jQuery = a("/m/base/jquery/jquery")
      , F = a("/m/base/util/gconfig")
      , G = a("{pluginBaseUrl}plugins/layer/scripts/layerUtils")
      , H = !1
      , I = {
        preHashUrl: "",
        startInitFlag: H,
...
define("/m/base/util/gconfig", [], function(a, b, c) {
    var d = configuration.projName || "project"
      , e = configuration.seaBaseUrl || "/m/"
      , f = {
        ...
        firstLoadCss: function() {
            var a = configuration.firstLoadCss;
            if (a) {
                for (var b = 0, c = a.length; c > b; b++)
                    a[b] = seajs._platRoot + a[b];
                return a
            }
            return [seajs._platRoot + e + d + "/css/app_style.css"]
        }(),
        projName: d,
        seaBaseUrl: seajs._platRoot + e,
        projPath: seajs._platRoot + e + d + "/",
        cssPath: seajs._platRoot + e + d + "/css/",
        imagesPath: seajs._platRoot + e + d + "/images/",
        scriptsPath: seajs._platRoot + e + d + "/scripts/",
        viewsPath: seajs._platRoot + e + d + "/views/",
...
define("/m/base/util/map", [], function(a, b, c) {
    function d() {
...
define("/m/base/util/nativeJsExt", [], function() {
    Date.prototype.format = function(a) {
        ...
        for (var d in b)
            new RegExp("(" + d + ")").test(a) && (a = a.replace(RegExp.$1, 1 == RegExp.$1.length ? b[d] : ("00" + b[d]).substr(("" + b[d]).length)));
        return a
    }
    ,
    ...
    String.prototype.startWith = function(a) {
        return StringHelper.isBlank(a) ? !1 : this.substr(0, a.length) === a ? !0 : !1
    }
    ,
    String.prototype.endsWith = function(a) {
        return StringHelper.isBlank(a) ? !1 : this.length <= a.length ? !1 : this.substr(this.length - a.length, this.length) === a ? !0 : !1
    }
    ,
...
define("/m/base/util/websocket", ["{pluginBaseUrl}plugins/layer/scripts/layerUtils", "jquery", "layer", "gconfig"], function(a, b, c) {
    function d() {}
    function e(a, b, c, d, e, g, h, i) {
        d = "undefined" == typeof d || "" === d ? !0 : d,
        e = "undefined" == typeof e || "" === e ? !0 : e,
        g = "undefined" == typeof g || "" === g ? !0 : g,
        h = "undefined" == typeof h || "" === h ? !0 : h,
        i = i || "请等待...";
        var j = b.infDescribe ? b.infDescribe : "";
        delete b.infDescribe;
        try {
            var k = new WebSocket(a);
            k.onopen = function() {
                g && f.iLoading(!0, i, h),
                k.send(b)
            }
            ...
            k.onmessage = function(a) {
                var b = a.data;
                b ? c && c(b) : f.iAlert(j + ">>后台返回数据格式不正确，请联系管理员！")
            }
            ,
            k.onclose = function() {
                d && f.iLoading(!1)
            ...
            console.printStackTrace(l)
        }
    }
    var f = a("{pluginBaseUrl}plugins/layer/scripts/layerUtils")
      , g = (new Array,
    {
        clearWebsocketReq: d,
        reqByWebSocket: e
